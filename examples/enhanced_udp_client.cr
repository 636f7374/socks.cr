...
# Create SOCKS::Frames::Authenticate.
...
client = SOCKS::Client.new host: "0.0.0.0", port: 1238_i32, dns_resolver: dns_resolver, options: options, timeout: SOCKS::TimeOut.new
...
client.wrapper = SOCKS::Options::Client::Wrapper::WebSocket.new address: SOCKS::Address.new(host: "0.0.0.0", port: 1238_i32), resource: "/", headers: HTTP::Headers.new, dataRaw: nil, enableConnectionIdentifier: true, allowConnectionReuse: true, allowConnectionPause: true, maximumSentSequence: Int8::MAX, maximumReceiveSequence: Int8::MAX
